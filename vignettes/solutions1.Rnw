...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: no function found corresponding to methods exports from 'SparseM' for: 'coerce'}}\end{kframe}
\end{knitrout}
...
\hlkwd{plot}\hlstd{(cars2010}\hlopt{$}\hlstd{FE,} \hlkwd{fitted.values}\hlstd{(m1}\hlopt{$}\hlstd{finalModel),}
     \hlkwc{xlab}\hlstd{=}\hlstr{"FE"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Fitted values"}\hlstd{,}
     \hlkwc{xlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{75}\hlstd{),} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{75}\hlstd{) )}
...
\hlkwd{plot3d}\hlstd{(m3,cars2010}\hlopt{$}\hlstd{EngDispl, cars2010}\hlopt{$}\hlstd{NumCyl,}
       \hlstd{cars2010}\hlopt{$}\hlstd{FE,} \hlkwc{points} \hlstd{=} \hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{m4} \hlkwb{=} \hlkwd{train}\hlstd{(FE}\hlopt{~}\hlstd{EngDispl}\hlopt{*}\hlstd{NumCyl} \hlopt{+} \hlkwd{I}\hlstd{(NumCyl}\hlopt{^}\hlnum{5}\hlstd{),} \hlkwc{data} \hlstd{= cars2010,} \hlkwc{method} \hlstd{=} \hlstr{"lm"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
