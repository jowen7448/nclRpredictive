...
{\centering \includegraphics[width=\maxwidth]{knitr_figure/practical1-unnamed-chunk-8-1} 
...
{\centering \includegraphics[width=\maxwidth]{knitr_figure/practical1-figure2-1} 
...
{\centering \includegraphics[width=\maxwidth]{knitr_figure/practical1-figure3-1} 
